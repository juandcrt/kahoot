...
<body>
    ...
    <div class="main-container">
        ...
        <div class="glass-card">
            <h2 style="font-size: 28px; font-weight: 800; margin-bottom: 10px;">¡Panel de Control Docente 👨‍🏫!</h2>
            <p style="color: rgba(255,255,255,0.7); font-size: 15px; line-height: 1.6;">
                Has iniciado sesión correctamente como profesor. Desde aquí podrás gestionar las salas de juego en tiempo real y subir material para generar cuestionarios automatizados.
            </p>
        </div>

        <!-- Módulos del Sistema para Profesor -->
        <div class="glass-card" style="padding-top: 25px;">
            <h3 style="font-size: 20px; font-weight: 700; margin-bottom: 5px;">Módulos del Sistema (Profesor)</h3>
            <p style="font-size: 13px; color: rgba(255,255,255,0.6); margin-bottom: 20px;">Selecciona una opción para gestionar tus clases:</p>

            <div class="grid-cards">
                <div class="action-card">
                    <div class="action-title">Gestión de Cuestionarios</div>
                    <div class="action-desc">Sube temas en PDF o Excel para generar preguntas automáticas o créalas de forma manual estilo formulario.</div>
                    <a href="{{ route('cuestionario.crear') }}" class="kahoot-action-btn" style="background: linear-gradient(135deg, #46178f 0%, #2a0b5c 100%); box-shadow: 0 4px 0 #1b053d;">Crear Cuestionario</a>
                </div>

                <div class="action-card">
                    <div class="action-title">Gestionar Salas Activas</div>
                    <div class="action-desc">Genera el PIN de la sala en vivo, proyecta las preguntas en el aula y supervisa el ranking de los estudiantes.</div>
                    <a href="{{ route('profesor.salas') }}" class="kahoot-action-btn">Ver Salas y PIN</a>
                </div>
            </div>
        </div>
    </div>
