...
<head>
    ...
    <title>Panel de Docente — Kahoot 2.0</title>
...
<body>
    ...
    <div class="main-container">
        <!-- Barra de Navegación -->
        <div class="dash-nav">
            <a href="#" class="dash-logo">Kahoot! 2.0 (Docente)</a>
            <div class="user-info">
        ...
        <div class="glass-card">
            <h2 style="font-size: 28px; font-weight: 800; margin-bottom: 10px;">¡Panel de Docente / Admin 👨‍🏫!</h2>
            <p style="color: rgba(255,255,255,0.7); font-size: 15px; line-height: 1.6;">
                Control total de tus cuestionarios, carga de material en PDF para generación automática y administración de salas en vivo para tus alumnos.
            </p>
        </div>

        <!-- Módulos de Gestión del Profesor -->
        <div class="glass-card" style="padding-top: 25px;">
            <h3 style="font-size: 20px; font-weight: 700; margin-bottom: 5px;">Módulos de Gestión</h3>
            <p style="font-size: 13px; color: rgba(255,255,255,0.6); margin-bottom: 20px;">Herramientas disponibles para crear y evaluar:</p>

            <div class="grid-cards">
                <div class="action-card">
                    <div class="action-title">Crear Cuestionario & PDF</div>
                    <div class="action-desc">Diseña preguntas manuales o sube un documento PDF para procesar y armar el examen interactivo.</div>
                    <a href="{{ route('cuestionario.crear') }}" class="kahoot-action-btn" style="background: linear-gradient(135deg, #46178f 0%, #2a0b5c 100%); box-shadow: 0 4px 0 #1b053d;">Nuevo Cuestionario</a>
                </div>

                <div class="action-card">
                    <div class="action-title">Gestionar Salas y PIN</div>
                    <div class="action-desc">Inicia partidas en vivo, proyecta las preguntas en clase y revisa el ranking de puntajes.</div>
                    <a href="{{ route('profesor.salas') }}" class="kahoot-action-btn" style="background: linear-gradient(135deg, #1368ce 0%, #0d4fa4 100%); box-shadow: 0 4px 0 #0a3870;">Ver Salas Activas</a>
                </div>
            </div>
        </div>
    </div>
